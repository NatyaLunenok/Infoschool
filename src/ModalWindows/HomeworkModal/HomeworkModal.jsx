...
// const HomeworkModal = ({ isOpen, onClose, date, onHomeworkSubmit }) => {
...
//         setSelectedFiles([]);
//         setFileNames([]);
//     }, [date, homeworkText, selectedFiles, onClose, onHomeworkSubmit]);
...
//                     <h2 className={styles.modalTitle}>Домашнее задание на {date}</h2>
