...
// //         id: student.id,
// //         student: `${student.last_name} ${student.first_name}`,
// //         lastName: student.last_name, // Добавляем поле для сортировки
// //         firstName: student.first_name, // Добавляем поле для сортировки
// //         grades: gradesByDate
// //       };
// //     })
...
// //     try {
// //       setLoading(true);
// //       // Находим ID домашнего задания для этого урока
...
// //       // Запрашиваем данные по ID домашнего задания
  ...
  return (
    <div className={styles.tableContainer}>
      <div className={styles.tableWrapper}>
        <table className={styles.journalTable} ref={tableRef}>
          <colgroup>
            <col style={{ width: '50px' }} /> {/* Номер строки */}
            <col style={{ width: '200px' }} /> {/* Имя ученика */}
            {dates.map(() => (
              <col key={Math.random()} style={{ width: '100px' }} /> 
            ))}
          </colgroup>
          <thead>
            <tr className={styles.headerRow}>
